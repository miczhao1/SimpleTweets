...
class LoginActivity : OAuthLoginActionBarActivity<TwitterClient>() {
    ...
    override fun onLoginSuccess() {
        ...
        Log.i("Michelle", "Logged in successfully!") // when logging in to the app, we know it was successful!

        val i = Intent(this, TimelineActivity::class.java) // Create new intent to launch TimelineActivity where we see our empty Recycler View!
        startActivity(i)
    }
    ...
    fun loginToRest(view: View?) {
        client.connect() // define the client
    }
}